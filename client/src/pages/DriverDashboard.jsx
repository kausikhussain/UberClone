            ...
            <div className="absolute top-4 sm:top-8 right-4 sm:right-8 w-[calc(100%-32px)] sm:w-[420px] max-h-[calc(100vh-120px)] overflow-y-auto no-scrollbar z-20 pointer-events-none">
                ...
                <div className="pointer-events-auto">
                    {incomingRequest && !currentRide && (
                        <div className="dark-glass-panel border-[#00f2fe] rounded-3xl p-6 mb-6 shadow-[0_0_30px_rgba(0,242,254,0.2)] animate-slide-up relative overflow-hidden">
                    ...
                    {currentRide && (
                        <div className="dark-glass-panel rounded-3xl overflow-hidden shadow-[0_0_40px_rgba(0,0,0,0.4)] animate-slide-up">
